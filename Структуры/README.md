...
4. Возможность просмотра детальной информации о каждом элементе статистики (например, описание оружия или брони).
5. И самое главное: он должен выводиться зеленым цветом!

Для реализации этого задания вам потребуются знания работы со структурами и файлами на языке C++. Вы можете использовать любой удобный для вас способ хранения данных (например, массивы или связные списки).

#### Примерный план реализации
1. Создайте структуру для хранения информации о персонаже (здоровье, энергия, опыт и т.д.).
2. Создайте функцию для отображения статистики персонажа в виде таблицы.
3. Создайте функции для сохранения и загрузки статистики персонажа в файл.
4. Создайте структуру для хранения информации о каждом элементе статистики (например, оружие или броня).
5. Создайте функции для добавления новых элементов статистики и сохранения их в файл.
6. Создайте функцию для просмотра детальной информации о каждом элементе статистики.
